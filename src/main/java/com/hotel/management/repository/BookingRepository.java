...
*/
   ...
   public int book(Booking booking)
   {
    ...
    public int cancelBooking(Booking cancelBooking)
    {
        return jdbcTemplate.update(Constants.CANCEL_BOOK, cancelBooking.bId, cancelBooking.userId, cancelBooking.date, cancelBooking.roomId);
    }
    public int deleteBooking(int bId){
       return jdbcTemplate.update(Constants.CANCEL_BOOK,bId);
    }
